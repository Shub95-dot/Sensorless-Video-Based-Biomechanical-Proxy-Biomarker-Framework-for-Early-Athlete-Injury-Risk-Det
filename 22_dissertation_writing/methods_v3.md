...
### 3.1 Deep-Flexion Constant Bias Isolation (Timing-Clean)
...
### 3.2 Robustness to Movement Conditions
...
### 3.3 Contralateral Occlusion Limitation
...
### 4.1 Projection and Motion Decompositions
...
### 4.2 Inverse-Variance Weighting & Cross-Exercise Transfer Weights
...
### 6.1 Modality Choice: Personalised-Deviation Screening (Option B)
...
### 7.2 Templates & Descriptive Guardrail
...
### 8.3 Classification Performance Metrics
