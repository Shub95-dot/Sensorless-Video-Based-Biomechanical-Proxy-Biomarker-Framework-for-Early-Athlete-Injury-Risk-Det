# Appendix A: Mathematical Derivation of Kinematic Uncertainty Weighting
...
Measurement weight $w_i$ and normalized weight $\bar{w}_i$ are given by [CITE: Borenstein_2013]:
