...
v2_text = r"""# Chapter 8: Uncertainty-Weighted Screening Framework
...
Sensitivity analysis confirmed weight ordering stable across assumed projection/motion splits, with weights varying less than 8.6%; full sweep details are provided in Appendix A [source: 17_uncertainty_framework_outputs/framework_design.md].
...
print("v2 Body Word Count:", len(v2_text.split()))
