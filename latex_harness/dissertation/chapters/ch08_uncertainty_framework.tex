...
The source of truth for measurement uncertainty is the drop-jump cohort validation agreement table ([phase6\_agreement\_final.csv](file:///c:/Users/shiro/OneDrive/Desktop/Python\%20files/BIOMECHANICAL\%20ANALYSIS\%20OF\%20INJURY/16\_opencap\_dropjump\_outputs/metadata/phase6\_agreement\_final.csv)), validating $n = 48$ drop-jump trials across $9$ subjects.
...
\hline
\textbf{Squat} & \texttt{PM\_008} & 2 & Correct & $0.82^\circ \pm 19.05^\circ$ & $62.16^\circ \pm 11.99^\circ$ & $117.02^\circ \pm 23.17^\circ$ & $58.51^\circ/\text{s} \pm 40.86^\circ/\text{s}$ \\
\textbf{Squat} & \texttt{PM\_008} & 17 & Incorrect & $2.23^\circ \pm 19.05^\circ$ & $50.03^\circ \pm 11.99^\circ$ & $127.73^\circ \pm 23.17^\circ$ & $105.18^\circ/\text{s} \pm 40.86^\circ/\text{s}$ \\
\textbf{Lunge} & \texttt{PM\_021} & 2 & Correct & $21.42^\circ \pm 19.05^\circ$ & $83.53^\circ \pm 11.99^\circ$ & $75.05^\circ \pm 23.17^\circ$ & $27.12^\circ/\text{s} \pm 40.86^\circ/\text{s}$ \\
\textbf{Lunge} & \texttt{PM\_021} & 7 & Incorrect & $18.51^\circ \pm 19.05^\circ$ & $54.65^\circ \pm 11.99^\circ$ & $106.84^\circ \pm 23.17^\circ$ & $69.57^\circ/\text{s} \pm 40.86^\circ/\text{s}$ \\
\hline
\end{tabular}
\end{table}
\end{landscape}
...
\begin{enumerate}
  ...
  \item \textbf{Temporal Sequence Models (Chapter 10)}: Leave-One-Subject-Out (LOSO) cross-validation established that peak flexion alone achieves optimal classification performance ($81.36\%$ squat / $81.50\%$ lunge balanced accuracy), outperforming complex trajectory shape models.
\end{enumerate}
