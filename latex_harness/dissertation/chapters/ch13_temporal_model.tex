...
Global LOSO classification metrics are presented in Table 13.1. Per-fold results were consistent with this aggregate pattern across all held-out subjects; the full fold-by-fold table is presented in Appendix B.
...
\begin{tabular}{p{2.6cm} p{3.4cm} l c c c c}
\hline
\textbf{Exercise} & \textbf{Normalization} & \textbf{Model} & \textbf{Accuracy} & \textbf{Balanced Acc} & \textbf{F1-Score} & \textbf{AUC-ROC} \\
\hline
\textbf{Squat} ($N=98$) & Scheme\_A (Offset Sub) & \textbf{naive} & $73.47\%$ & $50.00\%$ & $0.8471$ & $0.5000$ \\
 &  & \textbf{peak} & \textbf{$81.63\%$} & \textbf{$81.36\%$} & \textbf{$0.8676$} & \textbf{$0.9038$} \\
 &  & \textbf{shape} & $38.78\%$ & $33.76\%$ & $0.5161$ & $0.3531$ \\
 &  & \textbf{lstm} & $59.18\%$ & $53.79\%$ & $0.7015$ & $0.4931$ \\
 & Scheme\_B (Min-Max) & \textbf{naive} & $73.47\%$ & $50.00\%$ & $0.8471$ & $0.5000$ \\
 &  & \textbf{peak} & \textbf{$81.63\%$} & \textbf{$81.36\%$} & \textbf{$0.8676$} & \textbf{$0.9038$} \\
 &  & \textbf{shape} & $38.78\%$ & $33.76\%$ & $0.5161$ & $0.3531$ \\
 &  & \textbf{lstm} & $73.47\%$ & $50.00\%$ & $0.8471$ & $0.6050$ \\
\textbf{Lunge} ($N=61$) & Scheme\_A (Offset Sub) & \textbf{naive} & $59.02\%$ & $50.00\%$ & $0.0000$ & $0.5000$ \\
 &  & \textbf{peak} & \textbf{$80.33\%$} & \textbf{$81.50\%$} & \textbf{$0.7857$} & \textbf{$0.8289$} \\
 &  & \textbf{shape} & $57.38\%$ & $58.39\%$ & $0.5517$ & $0.5889$ \\
 &  & \textbf{lstm} & $54.10\%$ & $53.78\%$ & $0.4815$ & $0.5378$ \\
 & Scheme\_B (Min-Max) & \textbf{naive} & $59.02\%$ & $50.00\%$ & $0.0000$ & $0.5000$ \\
 &  & \textbf{peak} & \textbf{$80.33\%$} & \textbf{$81.50\%$} & \textbf{$0.7857$} & \textbf{$0.8289$} \\
 &  & \textbf{shape} & $57.38\%$ & $58.39\%$ & $0.5517$ & $0.5889$ \\
 &  & \textbf{lstm} & $42.62\%$ & $39.17\%$ & $0.2222$ & $0.4144$ \\
\hline
\end{tabular}
\end{table}
