...
\subsubsection*{§Table B.1: Sensitivity Sweep of Assumed Variance Splits Across 9 Configurations}
\begin{itemize}
  \item \texttt{17\_uncertainty\_framework\_outputs/framework\_design.md}
\end{itemize}
...
\subsubsection*{§Table D.1: Step 10 Screening vs. Step 11 XAI Parameter Cross-Check (Repetition 6)}
\begin{itemize}
