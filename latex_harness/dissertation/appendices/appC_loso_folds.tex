...
\subsection{Table B.1a: Squat Cohort LOSO Fold-by-Fold Results (9 Folds, N=98 Reps)}
...
\begin{tabular}{c p{3.5cm} p{3cm} c c c c}
\hline
...
\subsection{Table B.1b: Lunge Cohort LOSO Fold-by-Fold Results (7 Folds, N=61 Reps)}
